import {
  ...
  j as Me,
  k as ue,
} from "./chunk-ZSSD5RUB.js";
import { U as S, W as dt, a as le, c as ft } from "./chunk-OQHZ6M44.js";
function pt(i) {
  return new S(3e3, !1);
}
function jt() {
...
var vt = "",
  Qe = class {
    ...
    visitGroup(e, t) {
      ...
      return (
        (t.currentTime = n), { type: E.Group, steps: r, options: Y(e.options) }
      );
    }
    visitAnimate(e, t) {
            ...
            a.forEach((o, l) => {
              ...
              h &&
                (r != n &&
                  r >= h.startTime &&
                  n <= h.endTime &&
                  (t.errors.push(ts(l, h.startTime, h.endTime, r, n)),
                  (c = !1)),
                (r = h.startTime)),
...
function Y(i) {
  return (
    i ? ((i = le({}, i)), i.params && (i.params = Vs(i.params))) : (i = {}), i
  );
}
function ke(i, e, t) {
...
var Ve = class {
    ...
    _applyAnimationRefDelays(e, t, s) {
      for (let n of e) {
        ...
        if (r) {
          let a =
            typeof r == "number" ? r : $(ie(r, n?.params ?? {}, t.errors));
          s.delayNextStep(a);
        }
      }
    }
    ...
    visitStagger(e, t) {
      ...
      O(this, e.animation, t),
        ...
        (s.currentStaggerTime =
          n.currentTime - c + (n.startTime - s.currentTimeline.startTime));
    }
  },
  Se = {},
  Ue = class i {
  ...
  Xe = class {
    ...
    _getPreviousPlayers(e, t, s, n, r) {
      ...
      return (
        (s || n) &&
          (a = a.filter(
            (o) => !((s && s != o.namespaceId) || (n && n != o.triggerName))
          )),
        a
      );
    }
